    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.bottomSection}>
                <Text style={styles.title}>Historique de traçabilté</Text>
                <Text style={styles.subtitle}>Consultez l'historique des produits enregistrés</Text>
